...
import { sendToMOndayAction } from "@/app/contact-actions";
...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      try {
        const result = await sendToMOndayAction(null, formData);
        if (result.success) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Tem um projeto em mente? Preencha o formulário abaixo e nossa equipe
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    defaultValue=""
                    required
                    className="w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all text-gray-700 appearance-none cursor-pointer"
                  >
